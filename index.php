...
<head>
	...
	<link rel="canonical" href="soongsilctf.github.io/index.html">
	<meta name="description" content="숭실고등학교 해킹방어대회 사이트 입니다.">

	<!-- 웹표준 오픈 그래프 -->
	<meta property="og:type" content="website">
	<meta property="og:title" content="숭실고등학교 CTF">
	<meta property="og:description" content="숭실고등학교 해킹방어대회 사이트 입니다.">
	...
	<ul class="scene unselectable" data-friction-x="0.1" data-friction-y="0.1" data-scalar-x="25" data-scalar-y="15"
		...
		<li class="layer" data-depth="0.20">
			<div class="contact">
				<ul class="icons">
					<li>
						<a href="https://www.facebook.com/SHSCTF/"><i class="fa fa-facebook"></i></a>
					</li>
					<li>
						<a href="https://github.com/SOOGSILPCL"><i class="fa fa-github"></i></a>
					</li>
				</ul>
				<a class="mail" href="https://soongctf.com">2017 숭실고등학교 CTF</a>
				<br>
				<br>
				<a class="mail" href="https://soongsil.net">질문하기</a>
			</div>
		</li>
	</ul>
</div>
